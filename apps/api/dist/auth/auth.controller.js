...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Compte créé', type: dto_1.AuthResponseDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Connexion réussie', type: dto_1.AuthResponseDto }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Identifiants invalides' }),
    (0, swagger_1.ApiResponse)({ status: 429, description: 'Trop de tentatives - réessayez plus tard' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Token rafraîchi', type: dto_1.AuthResponseDto }),
