...
export declare class MatchingEngineController {
    ...
    constructor(matchingService: MatchingEngineService);
    createMission(user: CurrentUserPayload, dto: CreateMissionDto): Promise<{
    ...
    applyToMission(missionId: string, user: CurrentUserPayload, body: {
        coverLetter?: string;
        proposedRate?: number;
    }): Promise<{
        mission: {
