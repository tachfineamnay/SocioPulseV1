...
export const metadata: Metadata = {
    ...
    description: 'Découvrez les dernières offres de professionnels et besoins d\'établissements du secteur médico-social. Trouvez votre prochaine mission ou prestataire.',
    openGraph: {
