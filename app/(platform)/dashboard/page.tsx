                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    >
                        <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                            <Siren className="w-48 h-48 text-rose-500" />
                        </div>
                        <div className="relative z-10">
                            ...
                            <span className="inline-flex items-center gap-2 text-rose-600 font-medium group-hover:gap-3 transition-all">
                                Accéder au module
                    ...
                    <Link
                        href="/profile"
                        className="group p-8 bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-md hover:border-brand-100 transition-all duration-300"
                    >
